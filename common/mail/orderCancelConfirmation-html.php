<h4 style="text-align: center; color: red; border-top: 2px solid red; border-bottom: 2px solid red; padding: 10px; margin-bottom: 40px;">
...
<div style="margin-bottom: 50px;">www.yourhomehotel.ge</div>
